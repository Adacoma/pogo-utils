 ...
 * @brief Magnetometer calibration + reusable kinematics/PID/avoidance (API v2).
 *
 ...
 * heading window -> heading-hold at nominal motorHalf. Calibration sampling
